...
load("code1e03new_20260907.RData")
load("spatdiv.RData")
...
ER <- MCL0_p_exp.2_gpt(grid=coords, Z=Temp, center=center, border=border, core=K_hat)
...
LDK81 <- LDK_p(E=ER, center_p=center_p, grids=grid, core=49)
