...
1. simulation:  
   ...
   - **code1e03new_20260907.R**: Add two functions to generate identical Vehhia approximate sampling points for parallel and non-parallel computations in **code1e03new.R**.
...
3. Comparison with DeepKring in Table 3 and Table S7:
   - **DeepKriging_seed0**:
   - **DeepKriging_seed1**:
   - **DeepKriging_seed2**:
   - **DeepKriging_seed3**:
...
4. Comparison with convolution-based nonstationary models:
   - **Paciorek-Scherish process**: Table S5
   - **Scenario I**: Table S4
     
6. Sensitivity to the modeling partition: Table S3
   - **
